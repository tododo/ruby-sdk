...
# Unit tests for OrderCloud::AdminAddressApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdminAddressApi' do
  before do
    # run before each test
    @instance = OrderCloud::AdminAddressApi.new
  end
  ...
  describe 'test an instance of AdminAddressApi' do
    it 'should create an instact of AdminAddressApi' do
      expect(@instance).to be_instance_of(OrderCloud::AdminAddressApi)
    end
  end
