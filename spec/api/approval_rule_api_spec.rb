...
# Unit tests for OrderCloud::ApprovalRuleApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApprovalRuleApi' do
  before do
    # run before each test
    @instance = OrderCloud::ApprovalRuleApi.new
  end
  ...
  describe 'test an instance of ApprovalRuleApi' do
    it 'should create an instact of ApprovalRuleApi' do
      expect(@instance).to be_instance_of(OrderCloud::ApprovalRuleApi)
    end
  end
