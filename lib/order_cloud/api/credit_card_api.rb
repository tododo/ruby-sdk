...
module OrderCloud
  class CreditCardApi
    ...
    # @param card 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreditCard, Fixnum, Hash)>] CreditCard data, response status code and response headers
    ...
    # @option opts [Integer] :page_size Number of results to return per page. Default: 20, max: 100.
    # @option opts [Hash<String, String>] :filters Any additional key/value pairs passed in the query string are interpretted as filters. Valid keys are top-level properties of the returned model or &#39;xp.???&#39;
    # @return [Array<(ListCreditCard, Fixnum, Hash)>] ListCreditCard data, response status code and response headers
    ...
    # @option opts [Integer] :page Page of results to return. Default: 1
    # @option opts [Integer] :page_size Number of results to return per page. Default: 20, max: 100.
    # @return [Array<(ListCreditCardAssignment, Fixnum, Hash)>] ListCreditCardAssignment data, response status code and response headers
