...
module OrderCloud
  ...
  class AddressAssignment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IsShipping')
        self.is_shipping = attributes[:'IsShipping']
      end

      if attributes.has_key?(:'IsBilling')
        self.is_billing = attributes[:'IsBilling']
      end
    ...
    def hash
      [address_id, user_id, user_group_id, is_shipping, is_billing].hash
    end
