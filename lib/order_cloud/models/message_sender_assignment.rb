...
module OrderCloud
  ...
  class MessageSenderAssignment
    attr_accessor :message_sender_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MessageSenderID')
        self.message_sender_id = attributes[:'MessageSenderID']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          message_sender_id == o.message_sender_id &&
          buyer_id == o.buyer_id &&
          user_id == o.user_id &&
    ...
    def hash
      [message_sender_id, buyer_id, user_id, user_group_id, message_config_name].hash
    end
