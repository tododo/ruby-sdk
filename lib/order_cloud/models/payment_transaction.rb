...
module OrderCloud
  ...
  class PaymentTransaction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DateExecuted')
        self.date_executed = attributes[:'DateExecuted']
      end
    ...
    def hash
      [id, type, date_executed, amount, succeeded, result_code, result_message, xp].hash
    end
