...
module OrderCloud
  ...
  class CreditCard
    ...
    attr_accessor :partial_account_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PartialAccountNumber')
        self.partial_account_number = attributes[:'PartialAccountNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          partial_account_number == o.partial_account_number &&
    ...
    def hash
      [id, token, date_created, card_type, partial_account_number, cardholder_name, expiration_date, xp].hash
    end
