...
module OrderCloud
  ...
  class SecurityProfileAssignment
    attr_accessor :security_profile_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SecurityProfileID')
        self.security_profile_id = attributes[:'SecurityProfileID']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          security_profile_id == o.security_profile_id &&
          buyer_id == o.buyer_id &&
          user_id == o.user_id &&
    ...
    def hash
      [security_profile_id, buyer_id, user_id, user_group_id].hash
    end
