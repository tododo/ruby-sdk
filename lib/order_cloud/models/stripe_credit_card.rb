...
module OrderCloud
  ...
  class StripeCreditCard
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'AddressZip')
        self.address_zip = attributes[:'AddressZip']
      end

      if attributes.has_key?(:'AddressCountry')
        self.address_country = attributes[:'AddressCountry']
      end
    ...
    def hash
      [name, number, expiration_month, expiration_year, cvc, address_line1, address_line2, address_city, address_state, address_zip, address_country].hash
    end
